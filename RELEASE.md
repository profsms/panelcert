...
1. Confirm R-CMD-check, coverage, pkgdown, and cross-language parity are green on `main`.
2. Confirm `R CMD check --as-cran` reports zero errors and warnings. Before the
...
4. Tag and push `v0.5.1`; create a GitHub release from `NEWS.md`.
